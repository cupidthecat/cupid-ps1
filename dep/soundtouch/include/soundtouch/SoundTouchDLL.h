...
#define _SoundTouchDLL_h_
    ...
    /* cupid-ps1 patch: gate `extern "C"` on __cplusplus so this header works as
     * either a C or C++ include.  Upstream assumes always-C++. */
    #ifdef __cplusplus
    ...
    #else
      #if defined(DLL_EXPORTS) || defined(SoundTouchDLL_EXPORTS)
          #define SOUNDTOUCHDLL_API extern __attribute__((__visibility__("default")))
      #else
          #define SOUNDTOUCHDLL_API extern
      #endif
    #endif
...
SOUNDTOUCHDLL_API ST_HANDLE __cdecl soundtouch_createInstance(void);
